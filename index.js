    ...
    const text2 = "用鼠标随便点击一下!"
    const text3 = "看完之后可以点击下方按钮哦!"
    const text4 = "生日快乐呀！在这特别的一天，愿你的笑容灿烂如日，梦想如星光闪烁。我们一起走过了无数美好时光，未来更精彩。感谢你的陪伴和友情，你的成长是多彩的旅程，我骄傲且幸运能称你为妹妹。已经接近尾声了，不要忘记许下一个愿望，因为今天一切皆有可能。Happy Birthday!"
    let bodyClicked = false; 
    const body = document.querySelector('body');
    const divShell = document.querySelector('.shell');
    ...
    boxs.onclick = function() {
        if( divShell.style.transform === 'scale(2)'){
            divShell.style.transform = 'scale(1)';
        }
        else{
            divShell.style.transform = 'scale(2)';
            canvas.style.cursor = 'pointer';
        }
        divShell.style.transitionDuration = '1s';
    }
    ...
    btnContainer.onclick = function() {
        btnContainer.classList.add('clickedBtnContainer');
        divShell.classList.add('shellDesapear');
        ...
        setTimeout(function() {
            ...
            setTimeout(function() {
                ...
                cardContainer.style.transitionDuration = '3s';
                setTimeout(function() {
                    cardText(text4);
                    cardContainer.style.animation = "moveCard 3s ease forwards";
                    rainContainer.style.animation = "moveCloud 3s ease forwards";
                }, 2100)
            }, 3000)
        },3000)
        ...
        setTimeout(() => {
            ...
            setTimeout(function(){
                ...
                for (let i = 0; i < letters.length; i++) {
                    ...
                    letters[i].style.animationDelay = animationTime + "s";
                }
    ...
    body.onclick = function() {
        // Check if the body has already been clicked
        if (!bodyClicked && titleEnd) {
            body.style.cursor = 'default';
            divShell.style.transform = 'scale(1.5)';
            divShell.style.transitionDuration = '1s';

            setTimeout(function() {
                divShell.style.transform = 'scale(1)';
                divShell.style.transitionDuration = '2s';
